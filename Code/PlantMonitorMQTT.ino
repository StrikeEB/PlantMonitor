...
#include <ESP8266WebServer.h> // Huzzah web server
...
void sendMQTT() {
  ...
  Serial.println(msg);
  client.publish("student/CASA0014/plant/ucqbutk/temperature", msg);

  Humidity = dht.readHumidity(); // Gets the values of the humidity
  snprintf (msg, 50, "%.0f", Humidity);
  Serial.print("Publish message for h: ");
  Serial.println(msg);
  client.publish("student/CASA0014/plant/ucqbutk/humidity", msg);

  //Moisture = analogRead(soilPin);   // moisture read by readMoisture function
  snprintf (msg, 50, "%.0i", Moisture);
  Serial.print("Publish message for m: ");
  Serial.println(msg);
  client.publish("student/CASA0014/plant/ucqbutk/moisture", msg);
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str(), mqttuser, mqttpass)) {
      ...
      // ... and resubscribe
      client.subscribe("student/CASA0014/plant/ucqbutk/inTopic");
    } else {
